...
public class GravityMod {
    ...
    public static final String DEPENDENCIES_LIST = "required-after:forge@[14.23.4.2744,];after:" + ModSupport.BAUBLES_MOD_ID + "@[1.3.BETA9,];required-after:" + ModSupport.MIXIN_BOOTER + "@[7.0,];";
